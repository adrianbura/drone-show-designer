...
describe("dbg", () => {
  it("readiness", async () => {
    ...
    const recipe = makeTextRecipe({ text: "RALLY", weight: "REGULAR", style: "UPRIGHT", widthMeters: 90, heightMeters: 24, letterSpacingEm: 0.8, alignment: "CENTER", participation: f.points.length, outlineRatio: 0.7, bandOffsetEm: 0.35, seed: 1 });
