...
export function StudioProvider({ children }: { children: ReactNode }) {
  ...
  const selectSceneObject = useCallback(
    (objectId: string | null, mode: SceneClickMode = "REPLACE") => {
      ...
      // Authoring a visual must reveal the authored scene: imported reference
      // playback is read-only and would hide what the operator is editing.
  ...
  /** Choosing a transform tool reveals the authored scene (see selectSceneObject). */
