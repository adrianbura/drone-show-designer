...
const traj = evaluateGeometryTrajectoryConsequence(p, cand.project, { sampleRate: 8, assignmentStrategy: "index" as never });
...
const full = (await import("@/lib/show/fullshow")).analyzeFullShow(cand.project, { sampleRate: 8, assignmentStrategy: "index" as never }).report;
