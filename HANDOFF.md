...
- **Ultima stare analizată:** commit `c1df1ac` — Presentation viewport implementat.
- **Prioritate activă:** probă reproductibilă de performanță în browser la 150 și 500 de drone.
- **Intrări încă necesare pentru acceptanța reală:** arhiva ESSP de 150 de drone, configurația
  hardware/browser țintă și pragul FPS/frame-time acceptat.
- **Comandă de reluare:** când utilizatorul spune „continuă”, se pornește prioritatea activă din
  `roadmap.md`; dacă fixture-ul real lipsește, se construiește mai întâi infrastructura de test
  reproductibilă cu fixture sintetic, fără a pretinde validarea pe show-ul real.
